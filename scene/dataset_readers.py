...
def readNerfSyntheticInfo(path, white_background, eval, extension=".png"):
    ...
    # test_cam_infos = readCamerasFromTransforms(path, "transforms_extreme.json", white_background, extension)
...
def readDynamicNerfInfo(path, white_background, eval, extension=".png", target_path=""):
    ...
    if target_path != "":
        ...
        # test_cam_infos = readCamerasFromTransforms(target_path, "transforms_extreme.json", white_background, extension)
    else:
        test_cam_infos = readCamerasFromTransforms(path, "transforms_test.json", white_background, extension)
        # test_cam_infos = readCamerasFromTransforms(path, "transforms_extreme.json", white_background, extension)
    ...
    # test_mesh_infos = readMeshesFromTransforms(path, "transforms_extreme.json")
    if target_path != "":
        print("Reading Target Meshes (Test Division)")
        tgt_test_mesh_infos = readMeshesFromTransforms(target_path, "transforms_test.json")
        # tgt_test_mesh_infos = readMeshesFromTransforms(target_path, "transforms_extreme.json")
    else:
        tgt_test_mesh_infos = {}
